...
@section('pagetitle','image gallery')
              ...
              <div class="col-md-12 col-lg-6 col-xl-4" id="{{ $gthumbneal->id }}">
                ...
                <div class="card mb-2">
                  ...
                  <div class="card-img-overlay">
                    <h5 class="card-title bg-success text-secondary"><b>{{ $gthumbneal->menu }}</b></h5>
                    <p class="card-text pb-1 pt-1  bg-info text-white">
                        <b>
                ...
                <div class="row">
                    <a class="btn btn-app bg-success" href="{{ url('myadm/addmenu/viewimages/'.$gthumbneal->id) }}">
                  ...
                  <a class="btn btn-app bg-danger" onclick='imagecategorydelete("{{ $gthumbneal->id }}")'>
