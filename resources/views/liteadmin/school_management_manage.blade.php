  ...
  <div class="content-wrapper">
    ...
    <div id="sucessdata"></div>
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form enctype="multipart/form-data"  id="mannagement_school_form_data">
                @csrf
                <div class="card-body">
                        <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            <label for="menu">designation</label>
                            <input type="text" class="form-control" id="designation" name="designation" value="{{ $designation }}"placeholder="Enter name">
                          </div>
